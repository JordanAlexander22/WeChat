...
return(
    <div className= "Container">
        <div className= "innerContainer">
            ...
            <div><input placeholder= "Username" className= "joinInput" type= "text" onChange={(e) => setName(e.target.value)} /></div>
            ...
            <Link onClick= {e => (!name) || !room ? e.preventDefault() : null } to={`/chat?userName=${name}&room=${room}`} > 
